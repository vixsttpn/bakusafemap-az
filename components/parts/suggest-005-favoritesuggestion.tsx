...
export function FavoriteSuggestion({ name, subtitle, onClick, isLast }: Props) {
  return (
    ...
    >
      <div style={{width:28,height:28,borderRadius:8,background:'#FF3B3018',display:'flex',alignItems:'center',justifyContent:'center',flexShrink:0}}>
      ...
      <span style={{fontSize:9,color:'#8A8A8A',fontFamily:'Fragment Mono,monospace',textTransform:'uppercase',letterSpacing:1}}>favourite</span>
    </button>
  )
}
