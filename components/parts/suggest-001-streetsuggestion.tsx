...
export function StreetSuggestion({ name, subtitle, onClick, isLast }: Props) {
  return (
    ...
    >
      <div style={{width:28,height:28,borderRadius:8,background:'#8A8A8A18',display:'flex',alignItems:'center',justifyContent:'center',flexShrink:0}}>
        <div style={{width:6,height:6,borderRadius:'50%',background:'#8A8A8A'}}/>
      </div>
      ...
      <span style={{fontSize:9,color:'#8A8A8A',fontFamily:'Fragment Mono,monospace',textTransform:'uppercase',letterSpacing:1}}>street</span>
    </button>
  )
}
