...
export function RoadRepairCard({ time, verified, onVerify, onDismiss }: Props) {
  ...
  return (
    <div style={{background:'white',borderRadius:12,border:'1px solid rgba(0,0,0,0.05)',overflow:'hidden',marginBottom:8}}>
      ...
      <div style={{padding:'12px 14px',display:'flex',alignItems:'flex-start',gap:10}}>
        ...
        <div style={{flex:1}}>
          <div style={{fontSize:13,fontWeight:700,color:'#101828',fontFamily:'Inter,sans-serif'}}>Ремонт дороги</div>
          <div style={{fontSize:11,color:'#8A8A8A',marginTop:2}}>Сужение полосы</div>
